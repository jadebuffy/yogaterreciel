...
<section class="page-gallerie" id="photo">
        ...
        <div class="gallerie_video">
            ...
            <div class="videos">
                <video controls width=100%>
                    <source src="<?php the_sub_field( 'videos' );?>" type="video/mp4" alt="vidéo de la gallerie" loading="lazy">
                </video>
            </div>
            <?php endwhile; ?>
        </div>
    ...
    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/footerGallerie.png" class="imgfoot" alt="Série de 3 postures de yoga à l'encre de Chine" loading="lazy">
</section>   
